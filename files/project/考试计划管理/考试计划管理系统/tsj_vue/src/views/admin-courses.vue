<template>
  <div class="dashboard">
    ...
    <!-- 编辑课程弹窗 -->
    <el-dialog v-model="editCourseDialog" title="编辑课程信息" width="600px" :show-close="false" @close="resetEditForm">
    ...
    <!-- 新增课程弹窗 -->
    <el-dialog v-model="addCourseDialog" title="新增课程" width="600px" :show-close="false" @close="resetAddForm">
      <div class="form-content-wrapper">
...
.dialog-footer .action-btn.delete:active {
