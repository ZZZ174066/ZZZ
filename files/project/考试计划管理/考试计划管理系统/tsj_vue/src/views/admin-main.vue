    ...
    <el-dialog v-model="editDialog" title="编辑用户" width="400px" :show-close="false">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <button class="action-btn delete red-delete" @click="confirmDeleteUser">删除</button>
          <button class="action-btn save black-btn" @click="saveUser">保存</button>
        </div>
      </template>
    </el-dialog>

    <!-- 注册弹窗 -->
    <el-dialog v-model="registerDialog" title="用户注册" :width="registerForm.userType === 2 ? '800px' : '500px'" :show-close="false" @close="resetRegisterForm">
      <div class="form-content-wrapper">
...
.action-btn.red-delete:hover {
  background: #ff0000 !important;
  color: #ffffff !important;
  border-color: #ff0000 !important;
}

.action-btn.red-delete:active {
  background: #cc0000 !important;
  color: #ffffff !important;
  border-color: #cc0000 !important;
}
...
/* 黑底白字按键样式 */
.action-btn.black-btn {
  background: #000000 !important;
  color: #ffffff !important;
  border: 2px solid #000000 !important;
}

.action-btn.black-btn:hover {
  background: #333333 !important;
  color: #ffffff !important;
  border-color: #333333 !important;
}

.action-btn.black-btn:active {
  background: #000000 !important;
  color: #ffffff !important;
  border-color: #000000 !important;
}
